...
//new line example
    ...
    @GetMapping("/students")
    public List<Student> getStudentByyearOfEnrollent(@RequetParam int yearOfEnrollment) {
        return studentService.getStudentByyearOfEnrollent(yearOfEnrollment);
    }

    @GetMapping("/students/{studentId}/department")
    public String getDepartmentByStudentId(@PathVariable long studentId){
        return studentService.getDepartmentNameByStudentId(StudentId);
    }

    @DeleteMapping("/students/year/{yearofEnrollmet}")
    public void deleteStudentsByYearOfEnrollemnt(@PathVariable int yearOfEnrollment){
